...
public class RCraftMusicMod implements ModInitializer {
	...
	public static final ResourceKey<CreativeModeTab> RcraftItemGroup = ResourceKey.create(Registries.CREATIVE_MODE_TAB, new ResourceLocation(MODID, "rcraftmusic"));

	@Override
	public void onInitialize() {
		ITEMS = new RCraftItems();
		SOUNDS = new RCraftSounds();
		Registry.register(BuiltInRegistries.CREATIVE_MODE_TAB, RcraftItemGroup, FabricItemGroup.builder().icon(() -> new ItemStack(RCraftItems.TONE_ITEM)) // icon
				.title(Component.translatable("itemGroup.rcraftmusic.rcraftmusic")) // title
